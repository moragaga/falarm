...
def register_alarm_rule_management_callbacks() -> None:
    ...
    @app.callback(
        ...
        Input(
            component_id=AlarmRuleManagementIds.REAPPEAR_IF_STILL_ACTIVE_ENABLED,
            component_property='value',
        ),
        Input(
            component_id=AlarmRuleManagementIds.REAPPEAR_AFTER_MANAGEMENT_MINUTES,
            component_property='value',
        ),
        Input(
            component_id=AlarmRuleManagementIds.USE_MESSAGE_MANAGEMENT_OVERRIDE,
            component_property='value',
        ),
